...
function(init_directml_cache_variables prefix)
    ...
    set(${prefix}_DIRECTML_NUGET_HASH 
        052224190fa5db862694c29799c8eb7945191f5d0046b736f9864bd98417da14
...
function(init_directml_target_nuget target_name pkg_id pkg_version pkg_hash)
    ...
    if(TARGET_WINDOWS)
        ...
        target_link_libraries(${target_name} INTERFACE "${bin_path}/DirectML.lib")
...
function(init_directml_target_winsdk target_name)
    ...
    target_link_libraries(${target_name} INTERFACE directml.lib)
