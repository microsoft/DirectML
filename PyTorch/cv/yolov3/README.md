...
```
pip install -r pytorch\cv\yolov3\requirements.txt 
```
...
```
python pytorch\cv\yolov3\train.py --batch-size 4 --device dml --nosave --notest
```
...
image 1/2 F:\xianz\DirectML\pytorch\cv\yolov3\data\images\bus.jpg: 640x480 4 persons, 1 bus, Done. (0.285s)
image 2/2 F:\xianz\DirectML\pytorch\cv\yolov3\data\images\zidane.jpg: 384x640 2 persons, 3 ties, Done. (0.170s)
